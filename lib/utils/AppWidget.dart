...
BoxDecoration boxDecoration({double radius = 2, Color color = Colors.transparent, Color? bgColor, var showShadow = false}) {
  return BoxDecoration(
    color: bgColor ?? scaffoldLightColor,
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Text(text, style: primaryTextStyle(size: textSize ?? 18, color: textColor ?? textPrimaryColor)).expand(),
            ],
          ).expand(),
...
//             ? const Icon(Icons.arrow_forward_ios, size: 15, color: textPrimaryColor)
